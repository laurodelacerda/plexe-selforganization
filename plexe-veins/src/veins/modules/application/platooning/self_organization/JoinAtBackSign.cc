...
//    checkJoin = new cMessage("checkJoin");
}

JoinAtBackSign::~JoinAtBackSign()
{
//    cancelAndDelete(checkJoin);
//    checkJoin = nullptr;
}

void JoinAtBackSign::startManeuver(const void* parameters)
{
...
void JoinAtBackSign::abortManeuver()
{
}

void JoinAtBackSign::onPlatoonBeacon(const PlatooningBeacon* pb)
{
...
void JoinAtBackSign::handleJoinPlatoonRequest(const JoinPlatoonRequest* msg)
{
...
void JoinAtBackSign::handleJoinPlatoonResponse(const JoinPlatoonResponse* msg)
{
...
void JoinAtBackSign::handleMoveToPosition(const MoveToPosition* msg)
{
    if (app->getPlatoonRole() != PlatoonRole::JOINER) return;
...
void JoinAtBackSign::handleMoveToPositionAck(const MoveToPositionAck* msg)
{
