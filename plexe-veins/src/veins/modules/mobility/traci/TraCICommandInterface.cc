...
{
    return traci->genericGetString(CMD_GET_POI_VARIABLE, poiId, VAR_TYPE, RESPONSE_GET_POI_VARIABLE);
}
...
void TraCICommandInterface::Vehicle::getCustomParameter(const std::string& parameter, std::string& value)
{
    std::stringstream par;
    par << parameter ;
