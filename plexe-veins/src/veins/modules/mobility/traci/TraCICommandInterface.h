...
public:
    ...
    public:
        ...
        void getCustomParameter(const std::string& parameter, std::string& value);
        /**
...
private:
    ...
    Coord genericGetCoord(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, bool convert = true);
